...
q_optimal_policy_iter, optimal_policy_policy_iter = agent.control("policy iteration", gamma = gamma, threshold = threshold_dp, max_iter = max_iter_dp)
q_optimal_value_iter, optimal_policy_value_iter = agent.control("value iteration", gamma = gamma, threshold = threshold_dp, max_iter = max_iter_dp)
...
print('*'*30)
print(f'Optimal Policy Q Policy Iteration: {q_optimal_policy_iter}')
print(f'Optimal Policy Q Value Iteration: {q_optimal_value_iter}')
...
q_optimal_off_mc, optimal_policy_off_mc = agent.control("off-policy MC", max_episode_num = max_episode_num, max_episode_length = max_episode_length, gamma = gamma)
print(f'Optimal Policy Q off-policy MC: {q_optimal_off_mc}')
q_optimal_off_mc_polyak_ruppert, optimal_policy_off_mc_polyak_ruppert = agent.control("off-policy MC", max_episode_num = max_episode_num, max_episode_length = max_episode_length, gamma = gamma, Polyak_Ruppert = True)
print(f'Optimal Policy Q off-policy MC Polyak-Ruppert: {q_optimal_off_mc_polyak_ruppert}')
